...
namespace Sttp.DataPointEncoding
{
    public sealed class AdvancedEncoder : EncoderBase
    {
        ...
        private BitStreamWriter m_streamWriter;
        /// <summary>
        /// </summary>
        ...
        {
            m_streamWriter = new BitStreamWriter();
        }

        public override int Length => m_streamWriter.Length;
        ...
        {
            return new CommandDataStreamAdvanced(m_streamWriter.ToArray(), m_streamWriter.ToArray());
        }
