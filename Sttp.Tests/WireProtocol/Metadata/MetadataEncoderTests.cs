...
namespace Sttp.Tests
{
    ...
    public class MetadataEncoderTests
    {
        ...
        public void TestAddTable(short tableIndex, string tableName, TableFlags tableFlags)
        {
        ...
        public void TestAddColumn(short tableIndex, short columnIndex, string columnName, Sttp.WireProtocol.ValueType columnType)
        {
            m_encoder.BeginCommand();
        ...
        [DataTestMethod]
        [DataRow(1, 2)]
        public void TestAddRow(short tableIndex, int rowIndex)
        {
            m_encoder.BeginCommand();
        ...
        public void TestAddValue(short tableIndex, short columnIndex, int rowIndex, byte[] value)
        {
            m_encoder.BeginCommand();
        ...
        [DataTestMethod]
        [DataRow(1, 2)]
        public void TestDeleteRow(short tableIndex, int rowIndex)
        {
            m_encoder.BeginCommand();
