...
namespace Sttp
{
    public static class SttpValueEncodingWithoutType
    {
        ...
        public static SttpValue Load(ByteReader rd, SttpValueTypeCode value)
        {
            switch (value)
            {
                case SttpValueTypeCode.Null:
        ...
        public static void Load(ByteReader rd, SttpValueTypeCode value, SttpValueMutable output)
        {
            switch (value)
            {
                case SttpValueTypeCode.Null:
