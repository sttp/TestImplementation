...
//------------------------
//Note:
// The benefit of delta encoding is very insignificant, even more so if compression is enabled. Therefore
// this code has been commented out for the time being.
//------------------------
...
//            }
//            wr.WriteBits1(0);
//            SttpValueEncodingWithoutType.Save(wr, value);
//            return;
//            switch (type)
//            {
...
//            }
//            return SttpValueEncodingWithoutType.Load(rd, reference.ValueTypeCode);
...
//            SttpValueEncodingWithoutType.Load(rd, reference.ValueTypeCode, output);
//            return;
