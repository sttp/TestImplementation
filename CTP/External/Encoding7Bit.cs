...
namespace CTP
{
    ...
    public static class Encoding7Bit
    {
        ...
        {
            if (value1 < 0)
                throw new ArgumentOutOfRangeException(nameof(value1), "Cannot be negative");
            if (value1 < 128)
                return 1;
            return 2;
        }
        ...
        /// <param name="stream">A delegate where to read the next byte</param>
        /// <returns>the value</returns>
        public static unsafe uint ReadUInt32(ref byte* stream)
        {
            uint value11;
            value11 = *stream++;
            if (value11 < 128)
        ...
        /// <param name="value1">the value to write</param>
        [SuppressMessage("Microsoft.Design", "CA1045:DoNotPassTypesByReference", MessageId = "1#")]
        public static unsafe void Write(byte* stream, ref int position, ulong value1)
        {
            if (value1 < 128)
            {
                stream[position] = (byte)value1;
        ...
        /// <param name="stream">A delegate where to read the next byte</param>
        /// <returns>the value</returns>
        public static unsafe ulong ReadUInt64(ref byte* stream)
        {
            ulong value11;
            value11 = *stream++;
            if (value11 < 128)
