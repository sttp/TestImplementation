...
namespace CTP.IO
{
    ...
    public static unsafe class StreamExtensions
    {
        ...
        {
            Write(stream, BigEndian.GetBytes(value));
        }
        ...
        {
            stream.Write(BigEndian.GetBytes(value));
        }
        ...
        {
            return BigEndian.ToDecimal(stream.ReadBytes(16), 0);
        }
        ...
        {
            return ExtensionMethods.ToRfcGuid(stream.ReadBytes(16), 0);
        }
